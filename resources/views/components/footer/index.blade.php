<footer class="w-full py-20 bg-linear-to-t from-purple-600/20 to-gray-900  ">
    <div class="wrapper grid grid-cols-1 gap-4 md:gap-6 lg:gap-8 md:grid-cols-2 lg:grid-cols-4">
        <div class="space-y-6">
